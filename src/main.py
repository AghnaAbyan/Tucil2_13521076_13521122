...
startDnC = time.time()
shortestdnc, Point1dnc, Point2dnc, count2= util.closestPairWithDnC(arrayOfPoints, 0)
endDnC = time.time()
...
print("Banyak operasi euclidian distance    : " +str(count1) + " total operasi (spek = Intel Core i7)")
print("Waktu eksekusi                       : " +str(BFtime) + " detik")
...
print("Banyak operasi euclidian distance    : " +str(count2) + " total operasi (spek = Intel Core i7)")
print("Waktu eksekusi                       : " +str(DnCtime) + " detik")
